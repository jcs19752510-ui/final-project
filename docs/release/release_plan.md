...
| Week 4 | 리포트/대시보드 + QA + (여유 시) 화이트보드 + 데모 준비 | U4(완료, AC 8/8), U5(완료, AC 6/6), (U2-c), QA | **U4/U5 완료**(2026-09-07) — **Must-have 전체 완료**. 남은 QA는 GEMINI_API_KEY 확보 후 실제 LLM 검증, 프론트엔드 착수 여부는 사람 결정 필요 |
